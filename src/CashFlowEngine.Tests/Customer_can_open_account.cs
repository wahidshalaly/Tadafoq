...
namespace CashFlowEngine.Tests
{
	...
	public class Customer_can_open_account
	{
		...
		string description = "This is my checking account.";
		...
		{
			string name1 = "account one", description1 = "This is the first account";
			string name2 = "account two", description2 = "This is the second account";
